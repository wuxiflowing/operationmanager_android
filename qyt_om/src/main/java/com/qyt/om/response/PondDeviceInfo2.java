 ...
 * @e-mail:
 */
public class PondDeviceInfo2 implements Parcelable {
    /**
    ...
    protected PondDeviceInfo2(Parcel in) {
    ...
    public static final Creator<PondDeviceInfo2> CREATOR = new Creator<PondDeviceInfo2>() {
        @Override
        public PondDeviceInfo2 createFromParcel(Parcel in) {
            return new PondDeviceInfo2(in);
        }

        @Override
        public PondDeviceInfo2[] newArray(int size) {
            return new PondDeviceInfo2[size];
        }
    };
