...
import com.qyt.om.R;
import com.qyt.om.activity.RepairTaskDealActivity;
import com.qyt.om.activity.RepairTaskDetailActivity;
import com.qyt.om.activity.RetrieveTaskDealActivity;
import com.qyt.om.activity.RetrieveTaskDetailActivity;
import com.qyt.om.activity.RetrieveTaskFinishActivity;
 ...
 */
public class RetrieveTaskFragment extends BaseFragment {
    ...
    private RetrieveTaskAdapter installTaskAdapter;
    private int index;
    //    check(待審核)、prepare(待接單)、ing(進行中)、finish(已完成)
    private String[] stateType = new String[]{"prepare", "ing", "finish"};
    private int page = 0;
    public static RetrieveTaskFragment newInstance(int position) {
        RetrieveTaskFragment f = new RetrieveTaskFragment();
    ...
    private void initView() {
        ...
        installTaskAdapter = new RetrieveTaskAdapter(getContext(), installTaskModels);
