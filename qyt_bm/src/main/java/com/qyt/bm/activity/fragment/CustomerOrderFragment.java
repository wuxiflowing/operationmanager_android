...
import com.qyt.bm.R;
import com.qyt.bm.activity.CustomerOrderDetailActivity;
import com.qyt.bm.activity.CustomerPactDetailActivity;
import com.qyt.bm.adapter.CustomerOrderAdapter;
...
public class CustomerOrderFragment extends BaseFragment {
    ...
    private CustomerOrderAdapter installTaskAdapter;

    public static CustomerOrderFragment newInstance(int position) {
        CustomerOrderFragment f = new CustomerOrderFragment();
    ...
    private void addViewListener() {
        ...
        installTaskAdapter.setRecyclerViewItemClickListener(new RecyclerViewItemClickListener<InstallTaskModel>() {
            ...
            public void onItemClick(int position, InstallTaskModel value) {
                goToActivity(CustomerOrderDetailActivity.class);
            }
    ...
    private void initView() {
        ...
        installTaskAdapter = new CustomerOrderAdapter(getContext(), installTaskModels);
