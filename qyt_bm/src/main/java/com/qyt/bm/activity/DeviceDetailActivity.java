...
import com.qyt.bm.R;
import com.qyt.bm.adapter.InfoMap14Adapter;
...
import com.qyt.bm.response.RawDeviceInfo;
...
public class DeviceDetailActivity extends BaseActivity {
    ...
    private InfoMap14Adapter sensorAdapter;
    private List<InfoMap> control1Items = new ArrayList<>();
    private InfoMap14Adapter control1Adapter;
    private List<InfoMap> control2Items = new ArrayList<>();
    private InfoMap14Adapter control2Adapter;
    ...
    protected void initView() {
        ...
        sensorAdapter = new InfoMap14Adapter(this, sensorItems);
        sensorInfos.setAdapter(sensorAdapter);
        control1Adapter = new InfoMap14Adapter(this, control1Items);
        control1Infos.setAdapter(control1Adapter);
        control2Adapter = new InfoMap14Adapter(this, control2Items);
        ...
        getData(HttpConfig.DEVICE_TEST_CONFIG.replace("{id}", deviceId), new ResponseCallBack<DeviceConfigInfo>() {
            ...
            public void onSuccessResponse(DeviceConfigInfo d, String msg) {
                ...
                if (d != null) {
                    ...
                    if (d != null && "0".equals(d.workStatus)) {
