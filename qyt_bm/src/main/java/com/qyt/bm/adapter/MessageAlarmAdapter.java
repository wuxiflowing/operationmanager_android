...
public class MessageAlarmAdapter extends BaseRecyclerAdapter<TaskMessageItem> {

    public MessageAlarmAdapter(Context mContext, List<TaskMessageItem> mData) {
        super(mContext, mData);
    }

    @Override
    protected RecyclerView.ViewHolder initViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_messagealarm, parent, false);
    ...
    protected void bindingViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.flagRead.setVisibility(View.GONE);
