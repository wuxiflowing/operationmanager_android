 ...
 */
public class RecycleFinishAdapter extends BaseSimpleAdapter<DeviceChoiceModel> {

    public RecycleFinishAdapter(Context mContext, List<DeviceChoiceModel> mData) {
    ...
    protected View getViewAtPosition(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.deviceCount.setText(model.deviceTypeId);
