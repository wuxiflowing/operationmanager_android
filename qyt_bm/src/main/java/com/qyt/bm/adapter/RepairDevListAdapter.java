...
public class RepairDevListAdapter extends BaseAdapter {

    private Context mContext;
    private List<DeviceConfigInfo> mDatas;

    public RepairDevListAdapter(Context mContext, List<DeviceConfigInfo> mDatas) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.sentryName.setText(mDatas.get(position).identifier);
        return convertView;
    }
