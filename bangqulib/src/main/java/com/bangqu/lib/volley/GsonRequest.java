 ...
 */
public class GsonRequest<T extends JsonElement> extends JsonRequest<T> {
    ...
    public GsonRequest(String url, String jsonReq, ResponseCallBack responseCallBack) {
        super(Method.POST, url, jsonReq, responseCallBack.listener, responseCallBack.errorListener);
        mGson = new Gson();
        mListener = responseCallBack.listener;
    }

    public GsonRequest(String url, boolean isPut, String jsonReq, ResponseCallBack responseCallBack) {
        super(Method.PUT, url, jsonReq, responseCallBack.listener, responseCallBack.errorListener);
        mGson = new Gson();
        mListener = responseCallBack.listener;
    }
